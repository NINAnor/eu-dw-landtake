...
var grid_old = ee.FeatureCollection('projects/nina/Arena/export_grid')
print("Grid size:", grid_old.size())
grid_old = grid_old.filter(ee.Filter.intersects('.geo', geometry2).not());

Map.addLayer(grid_old)

grid_old = grid_old.merge(grid.filterBounds(geometry))
...
Export.table.toAsset({
  collection: grid_old,
  assetId: 'Arena/export_grid_EEA39',
  description: 'export_grid_EEA39'
})
